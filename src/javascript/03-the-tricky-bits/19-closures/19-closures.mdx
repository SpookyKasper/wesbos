...
![console showing logs 'hey I am an inner var' followed by 'Hey I am the outer Var'](/210.png)
...
![console showing inner function snippet](/212.png)
...
![console showing logs 'HELLO wes', 'HELLO kait' and 'HEY kait'](/214.png)
...
![Editor showing highlighted inner scope](/215.png)

And we have outer scope here 👇

![Editor showing highlighted outer scope](/216.png)
...
![console showing logs with gameName as Hockey and score ranging from 1 to 4](/217.png)

What is happening there is the function that we create is called `win()`, and we are using a `score` variable.

So whenever we create the game, we create a score variable that gets a value of 0.
...
![console showing logs from multiple games](/218.png)

![Editor showing scope type as number](/219.png)
